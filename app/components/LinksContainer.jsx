...
const LinksContainer = ({isSmallHeaderActive, setIsSmallHeaderActive}) => {
  ...
  return (
    <div className={`justify-center items-center md:flex gap-1 ${isSmallHeaderActive?`md:relative fixed inset-x-0 inset-y-0 pt-10 p-3 bg-[#000000b9]  h-screen md:h-auto md:block md:bg-inherit md:p-0`:`hidden`} `}>
