  ...
  return (
    <div className="mt-2 mb-1">
      <button
        type="button"
        onClick={handleClick}
        className="inline-flex items-center gap-2 px-5 py-3 rounded-2xl font-semibold text-gray-900 shadow-lg border-2 border-[#A5DD9B] bg-white hover:bg-[#F6F193] hover:scale-105 hover:shadow-xl active:scale-100 transition-all duration-200"
      >
        <span className="w-6 h-6 flex items-center justify-center rounded-full bg-[#A5DD9B]/40">
